...
Then, we'll tidy the data. The following data will be recoded to use actual values rather than dummy values: father’s race (1 = White, 2 = Black, 3 = Asian, 4 = Puerto Rican, 8 = Other, 9 = Unknown)
...
## need to eliminate missing values recoded
```
